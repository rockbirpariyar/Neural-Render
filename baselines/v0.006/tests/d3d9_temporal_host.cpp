...
// -static -Ibuild/generated tests/d3d9_temporal_host.cpp src/grayscale_d3d9.cpp src/motion_d3d9.cpp -ld3dcompiler_47
...
float4 main(float2 uv : TEXCOORD0) : COLOR0 {
    ...
    [[maybe_unused]] void expected_colors(unsigned phase, float (&out)[16])
    {
        for (unsigned stripe = 0; stripe < 4; ++stripe)
        {
