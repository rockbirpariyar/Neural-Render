...
int wmain(int argc, wchar_t **argv) {
    ...
    require(std::string(*name) == "ENR v0.004", "unexpected add-on name");
    ...
    std::string expected = "ENR v0.004 initialized\r\n";
    ...
    std::cout << "PASS: exact 300-frame logging, 900 presents / 450 runtime callbacks / 0 draws / 0 failures, "
        "missing/duplicate finish_present boundaries, v0.004 startup, quiet unload\n";
    return 0;
}
